...
public class Duplicator {
    ...
    public Duplicator() {
        ...
        messagesCounter = Counter.build().name("hack_message_counts").help("Count of messages").labelNames("mk").register(registry);
        duplicateCounter = Counter.build().name("hack_duplicate_counts").help("Count of duplicate messages").labelNames("dk").register(registry);
